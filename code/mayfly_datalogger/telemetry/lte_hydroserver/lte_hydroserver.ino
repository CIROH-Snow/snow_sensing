 ...
 * Description: This is the Mayfly sketch for the deployment of a snow sensing
 *              station with telemetry of data to an instance of HydroServer.
 *
 ...
 * sketch to automatically publish data collected by a snow sensing
 * station to be sent to an instance of HydroServer using HTTP POST 
 * requests. A playground version of HydroServer is available for 
 * development and testing at https://playground.hydroserver.org. 
 * HydroServer uses UUIDs to identify specific datastreams so that Mayfly 
 * dataloggers can send data directly to HydroServer using telemetry.  
 * Each observed variable uses a unique UUID that is assigned by HydroServer 
 * to identify its datastream (the time series of data for that variable).
 * To use this sketch, you need to create a monitoring site in HydroServer
 * and add a datastream to the monitoring site for each variable measured
 * by the snow sensing station. HydroServer will assign UUIDs for each 
 * observed variable datastream. You need to copy those UUIDs into this
 * sketch. This example sketch uses a placeholder UUID wherever a UUID from
 * HydroServer is required. You need to change those UUIDs to use the 
 * ones assigned by HydroServer for your datastreams.
 * ======================================================================= */
...
const char* sketchName = "lte_hydroserver.ino";
...
//  SIM7080 does auto-bauding by default, but for simplicity we set to 9600
const int32_t   modemBaud = 9600;  
...
// measurement, so set the sensor's power pin to the switched pin which we 
// already defined
...
const char* UUIDs[] = {
    "12345678-abcd-1234-ef00-1234567890ab",  // sampNum
    "12345678-abcd-1234-ef00-1234567890ab",  // boardTemp
    "12345678-abcd-1234-ef00-1234567890ab",  // sp510volts
    "12345678-abcd-1234-ef00-1234567890ab",  // sp510rad
    "12345678-abcd-1234-ef00-1234567890ab",  // sp610volts
    "12345678-abcd-1234-ef00-1234567890ab",  // sp610rad
    "12345678-abcd-1234-ef00-1234567890ab",  // sl510thermistorVolts
    "12345678-abcd-1234-ef00-1234567890ab",  // sl510thermopileVolts
    "12345678-abcd-1234-ef00-1234567890ab",  // sl510rad
    "12345678-abcd-1234-ef00-1234567890ab",  // sl610thermistorVolts
    "12345678-abcd-1234-ef00-1234567890ab",  // sl610thermopileVolts
    "12345678-abcd-1234-ef00-1234567890ab",  // sl610rad
    "12345678-abcd-1234-ef00-1234567890ab",  // rawCountsVWC1
    "12345678-abcd-1234-ef00-1234567890ab",  // soilTemp1
    "12345678-abcd-1234-ef00-1234567890ab",  // soilEa1
    "12345678-abcd-1234-ef00-1234567890ab",  // vwc1
    "12345678-abcd-1234-ef00-1234567890ab",  // ec1
    "12345678-abcd-1234-ef00-1234567890ab",  // rawCountsVWC2
    "12345678-abcd-1234-ef00-1234567890ab",  // soilTemp2
    "12345678-abcd-1234-ef00-1234567890ab",  // soilEa2
    "12345678-abcd-1234-ef00-1234567890ab",  // vwc2
    "12345678-abcd-1234-ef00-1234567890ab",  // ec2
    "12345678-abcd-1234-ef00-1234567890ab",  // rawCountsVWC3
    "12345678-abcd-1234-ef00-1234567890ab",  // soilTemp3
    "12345678-abcd-1234-ef00-1234567890ab",  // soilEa3
    "12345678-abcd-1234-ef00-1234567890ab",  // vwc3
    "12345678-abcd-1234-ef00-1234567890ab",  // ec3
    "12345678-abcd-1234-ef00-1234567890ab",  // st110thermistorVolts
    "12345678-abcd-1234-ef00-1234567890ab",  // st110airTemp
    "12345678-abcd-1234-ef00-1234567890ab",  // sonarRange
...
// ==========================================================================
// Create a base 64 encoding of your HydroServer username and password using
// https://www.base64encode.org/ so you can authenticate with Hydroserver
// Replace the string with your encoded credentials
const char* base64Authorization = "YOUR_ENCODED_CREDENTIALS_HERE";  

// Create a data publisher for the HydroServer POST endpoint
