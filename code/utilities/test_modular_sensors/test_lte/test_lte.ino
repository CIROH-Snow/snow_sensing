 ...
 * to an instance of HydroServer using only the Mayfly board temperature as
 * a measured variable.
 *
...
// Just use the name you've given the site here.
// Make sure it is a string (in double quotations).
const char* LoggerID = "stationname";

// How frequently (in minutes) to log data
const uint8_t loggingInterval = 3;

// Your logger's timezone as an integer offset from UTC.
